...
#계정1
def sendID1():
    xpath = driver.find_element(By.XPATH,'//*[@id="j_username"]')
    xpath.send_keys("kisoo0423@daum.net")

    xpath2 = driver.find_element(By.XPATH,'//*[@id="j_password"]')
    xpath2.send_keys("kisoo0423@")
#계정2
def sendID2():
    xpath = driver.find_element(By.XPATH,'//*[@id="j_username"]')
    xpath.send_keys("")
...
def loginclick():
    driver.find_element(By.XPATH,'/html/body/section/section/div/div/div[2]/div/div[2]/div/button').click()
